var legitValidation = {
   ...
   */
  performValidation: function (attrValidation, currentAttrVal, attr, silent) {
   ...
   */
  trackInvalidAttribute: function (attr, msg) {
   ...
   * @param  {String} msg  The error message.
   */
  trackValidAttribute: function (attr, msg) {
    var invalidAttrObject = {
      attr: attr,
      msg: msg
    };
   ...
   */
  triggerValidationEvents: function () {
   ...
   */
  shouldValidate: function (attrValidation) {
   ...
   */
  runValidator: function (attrValidation, value) {
   ...
   */
  validateHasValue: function (value) {
